...
class _MainAppState extends State<MainApp> {
  ...
  Future<void> checkconnection() async {
    if(await Logique.checkInternetConnection()){
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Vous etes connecté à internet"), backgroundColor: Colors.green,));
    }else{
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Connectez-vous à internet"), backgroundColor: Colors.red,));
    }
  }
